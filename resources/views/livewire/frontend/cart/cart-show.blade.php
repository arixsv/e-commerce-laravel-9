        ...
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="shopping-cart">
                        ...
                        @forelse ($cart as $cartItem)
                            ...
                            @endif
                        @empty
                            <div>Tidak Ada Item di Keranjang</div>
                        @endforelse
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5>
                        Dapatkan penawaran terbaik & <a href="{{ url('/collections') }}">belanja sekarang</a>
                    </h5>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        ...
                        <hr>
                        <a href="{{ url('/checkout') }}" class="btn btn-warning text-white w-100">Checkout</a>
                    </div>
                </div>
            </div>
