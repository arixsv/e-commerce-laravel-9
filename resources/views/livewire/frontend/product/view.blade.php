            ...
            <div class="row">
                <div class="col-md-5 mt-3">
                    <div class="bg-white border" wire:ignore>
                        ...
                        @else
                            Foto Product Tidak Ditambahkan
                        @endif
                    </div>
                </div>
                            ...
                            @if ($product->productColors->count() > 0)
                                ...
                                <div>
                                    @if ($this->prodColorSelectedQuantity == 'outOfStock')
                                        <label class="btn-sm py-1 mt-2 text-white bg-danger">Stock Habis</label>
                                    @elseif ($this->prodColorSelectedQuantity > 0)
                                        <label class="btn-sm py-1 mt-2 text-white bg-success">Ready Stock</label>
                                    @endif
                                </div>
                            @else
                                @if ($product->quantity)
                        ...
                        <div class="mt-2">
                            ...
                            <button type="button" wire:click="addToWishlist({{ $product->id }})" class="btn btn1"> 
                                <span wire:loading.remove wire:target="addToWishlist">
                                    <i class="fa fa-heart"></i> Tambahkan ke Favorit 
                                </span>
